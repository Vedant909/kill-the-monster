...
function setup() {
  ...
  ground = new Ground(600, 700, 1750, 20);

  hero = new Hero(400,800,250);
  rope = new Rope(hero.body, { x: 500, y: 50 });
  monster = new Monster(1100,550,300);
//create four tower,1st tower = 7 box,2nd t = 6 box,3rd t = 8 box,4th t = 5 box
  box1 = new Box(600, 200, 70, 70);
  box2 = new Box(900, 100, 70, 70);
  box3 = new Box(900, 100, 70, 70);
  box4 = new Box(900, 100, 70, 70);
  box4 = new Box(400, 200, 70, 70);
  box5 = new Box(200, 400, 70, 70);
  box6 = new Box(500, 300, 70, 70);
  box7 = new Box(300, 500, 70, 70);
  box8 = new Box(200, 500, 70, 70);
